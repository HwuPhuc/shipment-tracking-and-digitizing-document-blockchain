...
- Bước 5: Ở góc trên, chọn biểu tượng danh mục, và chọn Add a custom network, điền thông tin như sau và thêm network  
       ...
       Chain ID =  31337  
       Currency Symbol = ETH  
- Bước 6: Quay lại trang chủ của MetaMask, chọn biểu tượng tài khoản -> Import Account, chọn Private Key và dán các Private Key tương ứng với 6 tài khoản của 6 participant khác nhau đã tạo ở trên (ở cửa sổ Terminal thứ 2)  
